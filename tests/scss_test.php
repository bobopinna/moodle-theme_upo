...
/**
 * This file contains the unittests for upo's scss compilation.
 *
 * @package   theme_upo
 * @category  test
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class theme_upo_scss_testcase extends advanced_testcase {
    /**
     * Test that upo can be compiled using SassC (the defacto implemention).
     */
    public function test_scss_compilation_with_sassc() {
        ...
        $this->assertNotEmpty(
            theme_config::load('upo')->get_css_content_debug('scss', null, null)
        );
    }
}
